...
function MainBanner() {
  return (
    <>
      <div className="flex flex-col md:flex-row items-center rounded-[32px]  text-surface shadow-secondary-1 bg-gradient-to-t from-blue-800 to-blue-600 text-[#EBEBEB]  xl:flex-row max-w-screen-xl my-16 lg:px-14 py-14">
        <div className="flex flex-col justify-start p-6 mx-5">
          <div className="border-2 max-w-48 text-center rounded-[40px] py-2 mb-8">
            Your Web Experts
          </div>
          <p className="mb-8 lg:text-5xl md:text-3xl text-2xl lg:text-start md:text-start text-center font-semibold tracking-wide">
            Transform your vision <br />
            into reality
          </p>
          <h3 className="lg:text-xl md:text-xl text-lg lg:text-start md:text-start text-center text-surface/75 dark:text-neutral-300 font-light tracking-wide">
        ...
        <Image src={Banner1} alt={""} className="lg:h-60 md:h-52 h-40" />
      </div>
      <div className="lg:my-20 text-[#EBEBEB]">
        <div className="text-center lg:text-5xl md:text-3xl text-2xl">
          Make life easier with a little help from
          <div className="text-center lg:text-5xl md:text-3xl text-2xl">
            our support
          </div>
        </div>
        <div className="flex flex-row items-center justify-center lg:my-20 md:my-14 my-10">
          <button
            type="button"
